...
public class MatchManager : MonoBehaviour
{
    ...
    void RandomizePairPlacements()
    {
        ...
        for (int i = 0; o < _matchEntities.Count; i++)
        {
    ...
    public void MatchCount(bool MatchConnected)
    {
        ...
        Debug.Log(mesage: "There are still " + _currentMatchCount + " matches remaining");

        if (_currentMatchCount == _totalMatchCount) { Debug.Log(mesage: "CONGRATS! All pairs matched"); }
    }
